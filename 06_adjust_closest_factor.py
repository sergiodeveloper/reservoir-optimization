...
plot_rule_adjustment_in_all_wells(
  ...
  title="Evolução do WEIF ajustando apenas os valores mais próximos da regra alvo por iteração",
  subtitle="Usando regras e funções proxy geradas pelo conjunto de dados simplificado",
  image_filename=output_image_filename,
  percentage_variation_title='Variação do WEIF ajustando o valor mais próximo da regra com dados simplificados',
